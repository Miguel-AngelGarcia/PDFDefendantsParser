...
files = [file for file in glob.glob("/Users/miguelgarcia/Desktop/Processed/4/*")]
...
for file_name in files:
    ...
    document_text = document_text.replace('Attorneys for Plaintiffs', 'AttorneysforPlaintiffs').replace('Attorney for Plaintiffs', 'AttorneyforPlaintiffs')
